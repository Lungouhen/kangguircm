    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <h3 class="text-2xl font-bold mb-4">Kanggui RCM</h3>
                <p class="text-gray-400 mb-4 max-w-md">
                    Professional Revenue Cycle Management solutions helping healthcare providers optimize their financial performance and focus on patient care.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('careers') }}" class="text-gray-400 hover:text-white transition">Careers</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li class="flex items-center space-x-2">
                        ...
                        <span>info@kanggui-rcm.com</span>
                    </li>
                    <li class="flex items-center space-x-2">
                        <svg class="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
