...
@section('title', 'Contact Us - Kanggui RCM')
@section('meta_description', 'Get in touch with Kanggui RCM for revenue cycle management solutions')
...
@section('content')
    ...
    <section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto">
                Ready to optimize your revenue cycle? Get in touch with our team today.
            </p>
        </div>
    </section>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">123 Healthcare Drive<br>Medical Park, NY 10001</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">info@kangguircm.com<br>support@kangguircm.com</p>
                            </div>
                        </div>
    ...
    <!-- Map Placeholder -->
    <section class="bg-gray-100 h-96 flex items-center justify-center">
